...
#Retorna similaridade entre 2 usuarios
...
#Retorna similaridade entre todos usuarios
...
def carregaMovieLens(path='/home/diego/projetospy/ml-100k'):
    filmes = {}
